...
plot, rs, sfe, psym=8, /ylog, /xlog, xrange=[5.0e-1,100], $
      ...
      ytickformat='Exp2', position=[0.1,0.1,0.9,0.7], xtitle='!6z', /nodata 
...
sfrdata = read_ascii('../sfr.out', template=sfrfiletemplate)
...
plot, z, pop3_frac1, /ylog, /xlog, xrange=[5.0e-1,100], xstyle=1, yrange=[1.0e-4,1.0], $
      ytickformat='Exp2', position=[0.1,0.7,0.9,0.97], xtickname=tick, ytitle='ratio (popIII/total)'
