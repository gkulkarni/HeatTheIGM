...
metal_data = read_ascii('set69/halos_metals.out', template=stars_template)
gas_data =  read_ascii('set69/halos_gas.out', template=stars_template)
...
; xstyle=1
plot, z, Zmetal, /xlog, xrange=[1,100], ytitle='Z (Z!D'+sun+'!N)', $
