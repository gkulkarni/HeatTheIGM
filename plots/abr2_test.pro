...
; This is a copy of abr2.pro created in January 2021 for
; experimentation.
...
;----------------------------------------
  ...
  c_data2 = read_ascii('../halos_c.out', template=stars_template)
  fe_data2 = read_ascii('../halos_fe.out', template=stars_template)
  m_data2 = read_ascii('../halos.out', template=stars_template) 
  n_data2 = read_ascii('../nofmh.out', template=stars_template) 
  gas_data2 = read_ascii('../halos_gas.out', template=stars_template)
...
; Fe = Si 
  ...
  c_data2 = read_ascii('../halos_o.out', template=stars_template)
  fe_data2 = read_ascii('../halos_Si.out', template=stars_template)
  m_data2 = read_ascii('../halos.out', template=stars_template) 
  n_data2 = read_ascii('../nofmh.out', template=stars_template) 
  gas_data2 = read_ascii('../halos_gas.out', template=stars_template)
...
; Fe = Fe
  ...
  c_data2 = read_ascii('../halos_Zn.out', template=stars_template)
  fe_data2 = read_ascii('../halos_fe.out', template=stars_template)
  m_data2 = read_ascii('../halos.out', template=stars_template) 
  n_data2 = read_ascii('../nofmh.out', template=stars_template) 
  gas_data2 = read_ascii('../halos_gas.out', template=stars_template)
...
; Fe = O
  ...
  c_data2 = read_ascii('../halos_N.out', template=stars_template)
  fe_data2 = read_ascii('../halos_o.out', template=stars_template)
  m_data2 = read_ascii('../halos.out', template=stars_template) 
  n_data2 = read_ascii('../nofmh.out', template=stars_template) 
  gas_data2 = read_ascii('../halos_gas.out', template=stars_template)
