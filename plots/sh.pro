...
;; zn_data = read_ascii('set7/halos_Zn.out', template=stars_template)
;; fe_data =  read_ascii('set7/halos_fe.out', template=stars_template)
...
;; zn = zn_data.field001[95,*]
;; fe = fe_data.field001[95,*]
;; znbyfe = fltarr(100)
;; for i = 0, 99 do begin 
;;    if (zn[0,i] eq 0.0) then begin 
;;       znbyfe[i] = -10.0
